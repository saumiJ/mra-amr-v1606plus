...
#include "processorMeshesAMR.H"
#include "Time.H"
#include "primitiveMesh.H"

// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

void Foam::processorMeshesAMR::read()
{
...
Foam::processorMeshesAMR::processorMeshesAMR
(
...
Foam::fvMesh::readUpdateState Foam::processorMeshesAMR::readUpdate()
{
    ...
    forAll(databases_, procI)
    {
        ...
        */
        ...
        else if ((stat != procStat) && (stat != fvMesh::TOPO_PATCH_CHANGE) && (procStat != fvMesh::TOPO_PATCH_CHANGE))
        {
...
void Foam::processorMeshesAMR::reconstructPoints(fvMesh& mesh)
{
